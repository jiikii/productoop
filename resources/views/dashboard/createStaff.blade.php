                          ...
                          @endif
                            <form action="{{ Route('addStaff') }}" method="post">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text"  class="form-control"  placeholder="Product name" name="firstname"/>
                                    <input type="text"  class="visually-hidden"  placeholder="Product name" name="user_id" value="{{ Auth::user()->id }}"/>
                                </div>
                                <div class="mb-2">
                                    <label>Lastname</label>
                                    <input type="text"  class="form-control"  placeholder="Quantity" name="lastname"/>
                                </div>
                                <div class="mb-3">
                                    <label>Age</label>
                                    <input type="number" class="form-control"  placeholder="Price" name="age" />
                                </div>
                                <div class="mb-3">
                                    <label>Email </label>
                                    <input type="number" class="form-control"  placeholder="Price" name="email" />
                                </div>
                                <div class="mb-3">
                                    <label>PhoneNumber</label>
                                    <input type="number" class="form-control"  placeholder="Price" name="phoneNumber" />
                                </div>
                                <div class="mb-2">
